            ...
            <form action="/Article/update" method="post" class="add-article-form">
                <div class="col-md-9">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="article-title" name="title" class="form-control" placeholder="在此处输入标题"
                               value="这是测试的文章标题这是测试的文章标题这是测试的文章标题这是测试的文章标题" required autofocus autocomplete="off">
                    </div>
                    <div class="form-group">
                        <label for="article-content" class="sr-only">内容</label>
                        <script id="article-content" name="content" type="text/plain">
                            这是测试的文章内容这是测试的文章内容这是测试的文章内容这是测试的文章内容这是测试的文章内容这是测试的文章内容这是测试的文章内容这是测试的文章内容这是测试的文章内容这是测试的文章内容这是测试的文章内容这是测试的文章内容这是测试的文章内容这是测试的文章内容这是测试的文章内容这是测试的文章内容这是测试的文章内容这是测试的文章内容这是测试的文章内容这是测试的文章内容这是测试的文章内容这是测试的文章内容这是测试的文章内容这是测试的文章内容这是测试的文章内容这是测试的文章内容这是测试的文章内容这是测试的文章内容这是测试的文章内容这是测试的文章内容这是测试的文章内容这是测试的文章内容这是测试的文章内容这是测试的文章内容这是测试的文章内容这是测试的文章内容这是测试的文章内容这是测试的文章内容这是测试的文章内容这是测试的文章内容这是测试的文章内容这是测试的文章内容这是测试的文章内容这是测试的文章内容这是测试的文章内容这是测试的文章内容这是测试的文章内容这是测试的文章内容这是测试的文章内容这是测试的文章内容.
                        </script>
                    </div>
                    <div class="add-article-box">
                        <h2 class="add-article-box-title"><span>关键字</span></h2>
                        <div class="add-article-box-content">
                            <input type="text" class="form-control" placeholder="请输入关键字" value="测试,文章" name="keywords"
                                   autocomplete="off">
                ...
                <div class="col-md-3">
                    ...
                    <div class="add-article-box">
                        ...
                        <div class="add-article-box-content">
                            <input type="text" class="form-control" placeholder="输入新标签" value="测试,文章" name="tags"
                                   autocomplete="off">
